...
@Component({
  selector: 'app-pendientes-subgerente',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './pendientes-subgerente.html',
  styleUrl: './pendientes-subgerente.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PendientesSubgerenteComponent
  implements OnInit
{
  ...
  cargarSolicitudes(): void {
    ...
    this.vacacionesApi
      ...
      .subscribe({
        ...
        error: (error) => {
          console.error(
            'Error al consultar pendientes de Subgerencia:',
            error
          );
          ...
          this.errorMessage.set(
            this.obtenerMensajeError(
              error,
              'No se pudieron consultar las solicitudes pendientes de Subgerencia.'
            )
          );
    ...
    if (accion === 'aprobar') {
      this.vacacionesApi
        ...
        .subscribe({
          ...
          error: (error) => {
            console.error(
              'Error al aprobar definitivamente:',
              error
            );
            ...
            this.errorMessage.set(
              this.obtenerMensajeError(
                error,
                'No se pudo aprobar definitivamente la solicitud.'
              )
            );
